export default function Home() {
  return (
    <div className="text-slate-500">
      <h2 className="mb-6 text-4xl font-bold text-slate-300">About Me</h2>

      <p className="mb-8 text-lg">
        Hello! I'm{" "}
        <span className="font-semibold text-slate-300">Matt Hodgson</span>, a
        Software Engineer based in Prince George, BC. I specialize in crafting
      ...
      <h3 className="mt-10 mb-4 text-2xl font-semibold text-slate-300">
        My Journey
      </h3>
      <p className="mb-8 text-lg">
        Currently, I serve as a Senior Software Engineer at{" "}
        <span className="font-medium text-slate-300">xMatters</span>, where I
        lead frontend initiatives, refactor large-scale React components, and
        collaborate with cross-functional teams to enhance our digital
        operations platform.
      </p>
